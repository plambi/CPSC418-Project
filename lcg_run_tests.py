...
# List of your files
files = [
    "./lcg/time_lcg_nist_testdata.txt",
    "./lcg/urand_lcg_nist_testdata.txt",
    "./lcg/zero_lcg_nist_testdata.txt"
]

def run_tests_and_save():
    """Run all tests and save consolidated results"""
    output_file = f"LCG_test_results.log"
    
    with open(output_file, 'w') as out_f:
        out_f.write(f"LCG PRNG Test Results\n")
        out_f.write("="*80 + "\n\n")
