    ...
    for i in range(len(test_results)):
        ...
        for test in passes:
            if test == "11. Serial Test":
                ...
                bbs_result = test_results[i][test][1]
...
def calculate_results_single(directory, output_file_name, postfixes, generator):
    """
        ...
        Args:
            ...
            generator (string): Either lcg or bbs. Needed for file parsing.
...
if __name__ == "__main__":
    ...
    while True:
        try:
            which = int(input("Which of the 3 seeds do you want to analyze? \n 1. All 3 together \n 2. All 3 seprately \n 3. rand \n 4. urand \n 5. time\n"))
        except:
    ...
    try:
        if not(both_flag == "yes"):
            if all_flag:
                ...
                calculate_results_both(sys.argv[1], "_".join(postfixes), postfixes)
        else:
            if all_flag:
                ...
                calculate_results_single(sys.argv[1], "_".join(postfixes), postfixes, which_generator)
